...
public final class IOUtilities {
	private static final String TEMP_FILE_SUFFIX = ".rt-tmp";
	...
	/**
	 * Behaves much the same as {@link NbtIo#writeCompressed(CompoundTag, File)},
	...
	/**
	 * Behaves much the same as {@link NbtIo#write(CompoundTag, File)},
	 * but uses {@link #atomicWrite(Path, WriteCallback)} behind the scenes to
	 * ensure the data is stored resiliently.
	 *
	 * @param tag  The tag to write.
