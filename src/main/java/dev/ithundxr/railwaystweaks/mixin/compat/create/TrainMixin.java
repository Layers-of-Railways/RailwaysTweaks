...
public abstract class TrainMixin {
    ...
    private Pair<Train, Vec3> railwayTweaks$removeTrainCollisions(Train instance, Level level, Vec3 start, Vec3 end, ResourceKey<Level> dimension, Operation<Pair<Train, Vec3>> original) {
        return null;
    }
}
